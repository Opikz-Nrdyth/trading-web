            ...
            <div class="grid md:grid-cols-2 gap-10 items-center">
                <div>
                    <p class="text-lg leading-7 mb-4">
                        <span class="font-semibold text-yellow-400">{{ $company_name }}</span> is a platform built for
                        traders by
                ...
                <div class="rounded-xl overflow-hidden shadow-xl">
                    <img src="/images/teamwork.jpeg" alt="Our team" class="w-full h-auto object-cover" />
                </div>
            </div>
