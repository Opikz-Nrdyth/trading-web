        ...
        return $table
            ->columns([
                ...
                TextColumn::make('user.name')
                    ...
                    ->searchable()
                    ->sortable(),
                ImageColumn::make('identity_card')->width(50)->defaultImageUrl(fn($record) => asset(config('services.storage_public') . $record->identity)),
                ImageColumn::make('pas_photo')->width(50)->defaultImageUrl(fn($record) => asset(config('services.storage_public') . $record->photo)),
