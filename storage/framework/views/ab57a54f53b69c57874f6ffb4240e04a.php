...
$__html = app('livewire')->mount($__name, $__params, 'lw-3313937987-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3313937987-1', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\Bank Project\2025\trading web jadi\resources\views/SettingProfile.blade.php ENDPATH**/ ?>